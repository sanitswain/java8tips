Quick Introduction
==================
Java-8 launched on 18th March 2014 and it was a next major release after jdk5. It came up with large set of dazzling features that has won the attention of most of the java programmers. It has enhanced various corners of java like runtime environment, compiler, lexical parser, memory management, command line tools and many more. Java-8 will improve programmer's coding experience with its enticed features of declarative programming, passing code as an argument, method reference etc. It will assure you to write codes that will be more precise, objective driven and highly readable.
